...
define('new',['require','jquery','jquery.serializeObject','jquery.iframe-transport','ajax_upload','bootstrap','moment','bootstrap-datetimepicker','zh-CN','select2','parsley','django-csrf-support'],function(require) {
    require("jquery");
