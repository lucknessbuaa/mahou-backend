...
define('show',['require','jquery','jquery.serializeObject','jquery.iframe-transport','bootstrap','moment','bootstrap-datetimepicker','zh-CN','select2','parsley','django-csrf-support','when/when','underscore','backbone/backbone','errors','utils','formProto','formValidationProto','modals'],function(require) {
    require("jquery");
